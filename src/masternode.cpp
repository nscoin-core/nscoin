...
{
    if (blockHeight >= 0 && blockHeight < 5000) {
      switch(vin_val) {
          case 50 * COIN: return 1;
          case 250 * COIN: return 2;
          case 1000 * COIN: return 3;
      }
    } else if (blockHeight >= 5000 && blockHeight < 10000) {
      switch(vin_val) {
